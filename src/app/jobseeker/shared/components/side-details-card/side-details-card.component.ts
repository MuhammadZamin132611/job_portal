...
import { ProfileImagesService } from 'src/app/jobseeker/dashboard/services/profile-images.service';
import { NotificationsService } from 'src/app/jobseeker/dashboard/services/notifications.service';

@Component({
  selector: 'app-side-details-card',
  templateUrl: './side-details-card.component.html',
  styleUrls: ['./side-details-card.component.css']
})
export class SideDetailsCardComponent implements OnInit {
